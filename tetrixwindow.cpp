...
TetrixWindow::TetrixWindow()
{
    ...
    board->setStyleSheet("background-image: url(:/picture/arriere_plan.jpg);");

    scoreLcd = new QLCDNumber(2);
    scoreLcd->setSegmentStyle(QLCDNumber::Filled);
    scoreLcd->setStyleSheet("background-color: green");
    levelLcd = new QLCDNumber(2);
    levelLcd->setSegmentStyle(QLCDNumber::Outline);
    levelLcd->setStyleSheet("background-color: green");
    linesLcd = new QLCDNumber(2);
    linesLcd->setSegmentStyle(QLCDNumber::Outline);
    linesLcd->setStyleSheet("background-color: green");
   ...
   volumeDial->setStyleSheet("QDial{ background-color:red "
    ...
    layout->addWidget(createLabel(tr("PROCHAINE FORME")), 0, 9);
    layout->addWidget(nextPieceLabel, 1, 9);
    layout->addWidget(createLabel(tr("NIVEAU")), 2, 9);
	layout->addWidget(levelLcd, 3, 9);
    layout->addWidget(createLabel(tr("SCORE")), 4, 9);
    layout->addWidget(scoreLcd, 5, 9);
    layout->addWidget(createLabel(tr("LIGNES ENLEVEES")), 6, 9);
